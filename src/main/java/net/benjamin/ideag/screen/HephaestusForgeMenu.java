...
import net.benjamin.ideag.screen.slot.ModFuelSlot;
import net.benjamin.ideag.screen.slot.ModResultSlot;
...
public class HephaestusForgeMenu extends AbstractContainerMenu {
    ...
    public HephaestusForgeMenu(int windowId, Inventory inv, FriendlyByteBuf extraData) {
        this(windowId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(4));
    }

    public HephaestusForgeMenu(int windowId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.HEPHAESTUS_FORGE_MENU.get(), windowId);
        checkContainerSize(inv, 4);
        blockEntity = ((HephaestusForgeBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.HEPHAESTUS_FORGE.get());
    }
